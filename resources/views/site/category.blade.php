                            ...
                            <div class="ps-shoe mb-30">
                                <div class="ps-shoe__thumbnail">
                                    ...
                                    <div class="ps-badge ps-badge--sale ps-badge--2nd">
                                        ...
                                        <img
                                        src="{{ asset('uploads/images/products/'.$item->image) }}" alt=""><a class="ps-shoe__overlay"
                                        href="{{ route('site.product', $item->slug) }}"></a>
                                </div>
                                <div class="ps-shoe__content">
                                    <div class="ps-shoe__detail">
                                        <a class="ps-shoe__name" href="{{ route('site.product', $item->slug) }}">{{ $item->trans_name }}</a>
