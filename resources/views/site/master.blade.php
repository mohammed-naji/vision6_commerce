            ...
            <div class="container-fluid">
                ...
                <div class="navigation__column center">
                    <ul class="main-menu menu">
                        <li class="menu-item menu-item-has-children dropdown"><a href="{{ route('site.index') }}">Home</a>

                        </li>

                        @foreach (Category::whereNull('parent_id')->whereHas('children')->take(5)->get() as $item)
                            <li class="menu-item menu-item-has-children dropdown">
                                <a href="{{ route('site.category', $item->slug) }}">{{ $item->trans_name }}</a>
                                <ul class="sub-menu">
                                    @foreach ($item->children as $item2)
                                        <li class="menu-item"><a href="{{ route('site.category', $item2->slug) }}">{{ $item2->trans_name }}</a></li>
                                    @endforeach
                                </ul>
                            </li>
                        @endforeach
                        <li class="menu-item menu-item-has-children dropdown"><a href="{{ route('site.contact') }}">Contact</a></li>
                    </ul>
                </div>
