...
<body class="ps-loading">
                    ...
                    <div class="ps-cart">
                        ...
                        <div class="ps-cart__listing">
                            <div class="ps-cart__content">
                                ...
                                <div class="ps-cart-item"><a class="ps-cart-item__close" href="{{ route('site.remove_cart', $cart->id) }}"></a>
                                    ...
                                    <div class="ps-cart-item__content"><a class="ps-cart-item__title"
                                            href="{{ route('site.product', $cart->product_id) }}">{{ $cart->product->trans_name }}</a>
                                        <p><span>Quantity:<i>{{ $cart->quantity }}</i></span><span>Price:<i>{{ $cart->price }}</i></span></p>
                                    </div>
                                </div>
                                @endforeach
                            ...
                            <div class="ps-cart__total">
                                <p>Number of items:<span>{{ $items }}</span></p>
    ...
    <div class="ps-footer bg--cover" data-background="{{ asset('siteassets/images/background/parallax.jpg') }}">
